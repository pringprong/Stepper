...
2. Copy songs from your other song group folders into the new one.
...
Warnings: 
1. Although Stepper will create a backup of the old stepfile, there is no quick way to restore from backup. It's better to copy the song files to a new song group folder before you start instead of changing the old .sm files in place
