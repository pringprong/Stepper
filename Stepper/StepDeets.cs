		...
		public static Dictionary<string, Dictionary<string, NotesetParameters>> 
			default_params = new Dictionary<string,Dictionary<string,NotesetParameters>> {
				{ StepDeets.DanceSingle, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Novice, true, true, 50, 100, 0, 20, true, true)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Easy, true, false, 100, 100, 0, 20, true, false)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Medium, false, true, 100, 100, 15, 20, false, true)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Hard, false, false, 100, 80, 0, 0, false, false)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Expert, true, false, 100, 85, 20, 50, true, true)}, 
				} },
				{ StepDeets.DanceSolo, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Novice, true, false, 50, 100, 5, 20, true, false)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Easy, false, false, 100, 90, 0, 20, false, true)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Medium, false, true, 100, 100, 19, 20, false, false)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Hard, true, false, 100, 70, 0, 5, true, true)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Expert, true, true, 100, 80, 15, 30, true, true)}, 
				} },
				{ StepDeets.DanceDouble, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Novice, false, true, 50, 90, 0, 20, false, true)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Easy, false, false, 90, 100, 3, 20, false, false)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Medium, true, false, 100, 100, 20, 20, true, true)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Hard, true, true, 100, 100, 90, 10, true, true)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Expert, true, false, 100, 60, 60, 20, true, false)}, 
				} },
				{ StepDeets.PumpSingle, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Novice, false, false, 50, 100, 5, 100, true, true)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Easy, true, false, 100, 100, 0, 20, true, true)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Medium, true, true, 100, 100, 0, 20, true, true)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Hard, true, false, 100, 100, 0, 20, true, true)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Expert, false, true, 100, 100, 0, 20, true, true)}, 
				} },
			};
