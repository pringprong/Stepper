		...
		public static Dictionary<string, Dictionary<string, NotesetParameters>> 
			default_params = new Dictionary<string,Dictionary<string,NotesetParameters>> {
				{ StepDeets.DanceSingle, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Novice, true, true, 50, 100, 0, 20, true, true, 10)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Easy, true, false, 100, 100, 0, 20, true, false, 15)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Medium, false, true, 100, 100, 15, 20, false, true, 20)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Hard, false, false, 100, 80, 0, 0, false, false, 25)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.DanceSingle, StepDeets.Expert, true, false, 100, 85, 20, 50, true, true, 30)}, 
				} },
				{ StepDeets.DanceSolo, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Novice, true, false, 50, 100, 5, 20, true, false, 35)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Easy, false, false, 100, 90, 0, 20, false, true, 40)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Medium, false, true, 100, 100, 19, 20, false, false, 45)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Hard, true, false, 100, 70, 0, 5, true, true, 50)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.DanceSolo, StepDeets.Expert, true, true, 100, 80, 15, 30, true, true, 55)}, 
				} },
				{ StepDeets.DanceDouble, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Novice, false, true, 50, 90, 0, 20, false, true, 60)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Easy, false, false, 90, 100, 3, 20, false, false, 65)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Medium, true, false, 100, 100, 20, 20, true, true, 70)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Hard, true, true, 100, 100, 90, 10, true, true, 75)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.DanceDouble, StepDeets.Expert, true, false, 100, 60, 60, 20, true, false, 80)}, 
				} },
				{ StepDeets.PumpSingle, new Dictionary<string, NotesetParameters> {
					{ StepDeets.Novice, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Novice, false, false, 50, 100, 5, 100, true, true, 85)},
					{ StepDeets.Easy, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Easy, true, false, 100, 100, 0, 20, true, true, 90)},
					{ StepDeets.Medium, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Medium, true, true, 100, 100, 0, 20, true, true, 95)},
					{ StepDeets.Hard, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Hard, true, false, 100, 100, 0, 20, true, true, 100)},
					{ StepDeets.Expert, new NotesetParameters(StepDeets.PumpSingle, StepDeets.Expert, false, true, 100, 100, 0, 20, true, true, 0)}, 
				} },
			};
