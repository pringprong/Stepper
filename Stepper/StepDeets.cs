...
namespace Stepper
{
			...
			steps_3d_dictionary = new Dictionary<string, Dictionary<string, Dictionary<string, string[]>>> {
				...
				{ StepDeets.DanceDouble, new Dictionary<string, Dictionary<string, string[]>> {
					{ StepDeets.Left, new Dictionary<string, string[]>() { 
						...
						{ "00000010",/*righttop             */ new string[] {F, F, F, T, T, T, F, F} },
						{ "00000001",/*rightright           */ new string[] {F, F, F, T, T, T, T, F} },
                        {"00110000",/*lefttop leftright     */ new string[] {T, T, T, F, F, F, F, F} },
                        {"01100000",/*leftbottom lefttop    */ new string[] {T, T, T, T, T, T, T, F} },
                        {"01010000",/*leftbottom leftright  */ new string[] {T, T, T, F, F, F, F, F} },
                        {"11000000",/*leftleft leftbottom   */ new string[] {T, F, T, T, T, F, F, F} },
                        {"10010000",/*leftleft leftright    */ new string[] {T, T, T, F, F, F, F, F} },
                        {"10100000",/*leftleft lefttop      */ new string[] {T, T, F, T, F, F, F, F} }, // jumps on the left-hand side
                        {"00000011",/*righttop rightright   */ new string[] {F, F, F, T, T, T, T, F} },
                        {"00000110",/*rightbottom righttop  */ new string[] {F, T, T, T, T, T, T, F} },
                        ...
                        {"00100010",/*lefttop righttop      */ new string[] {F, T, T, T, T, T, F, F} },
					...
					{ StepDeets.Right, new Dictionary<string, string[]>() { 
						...
						{ StepDeets.Base, new string[] {
							...
							"00000010", /*righttop*/
							"00000001", /*rightright*/} },
						{ "10000000",/*leftleft             */ new string[] {F, T, T, T, T, F, F, F} },
						{ "01000000",/*leftbottom           */ new string[] {F, F, T, T, T, F, F, F} },
						{ "00100000",/*lefttop              */ new string[] {F, T, F, T, T, F, T, F} },
						{ "00010000",/*leftright            */ new string[] {F, F, F, F, T, T, T, T} },
						{ "00001000",/*rightleft            */ new string[] {F, F, F, F, F, T, T, T} },
						{ "00000100",/*rightbottom          */ new string[] {F, F, F, F, F, F, T, T} },
						{ "00000010",/*righttop             */ new string[] {F, F, F, F, F, T, F, T} },
						{ "00000001",/*rightright           */ new string[] {F, T, T, T, T, T, T, T} },
                        {"00110000",/*lefttop leftright     */ new string[] {F, T, F, T, T, F, T, F} },
                        {"01100000",/*leftbottom lefttop    */ new string[] {F, T, T, T, T, T, T, F} },
                        ...
                        {"00000110",/*rightbottom righttop  */ new string[] {F, T, T, T, T, T, T, T} },
	...
	steps_3d_dictionary_default = new Dictionary<string, Dictionary<string, Dictionary<string, string[]>>> {
		...
		public static Dictionary<string, string[]> getStepGrid(string dance_style, string foot)
		{
			return steps_3d_dictionary[dance_style][foot];
		}
